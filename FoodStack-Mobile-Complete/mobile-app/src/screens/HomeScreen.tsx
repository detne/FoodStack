...
const HomeScreen: React.FC<Props> = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    if (user) {
      console.log('🏠 HomeScreen: User role detected:', user.role);
      ...
      switch (user.role) {
        ...
        case 'CUSTOMER':
        default:
          console.log('👤 Staying on Customer Home');
          // Stay on current screen for customers
          break;
      }
    }
  ...
  // Show loading or redirect message for non-customers
