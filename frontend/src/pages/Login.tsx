          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Enter your details to manage your QR codes.
              </p>
            </div>
            ...
            <div className="relative mb-6">
              <Separator />
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-xs text-gray-500 uppercase">
                Or continue with
              </span>
            </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    type="button"
                    variant="link"
                    className="text-indigo-600 text-sm font-medium p-0 h-auto"
                  >
                    Forgot password?
                  </Button>
                </div>
